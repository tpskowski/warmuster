...
## Main UI
1. X to delete lists is not centered
2. We have duplicate general validations:
The army must include a General.
Warriors: at least 8 required (0 selected).
...
## Unit Cards
1. If ranged attacks are 2+bounce or otherwise long have this break to next line to not overlap with special rules
2. Print cannon rules on cannon cards